...
public class createScenarios_cutoutWorldSpeed {
    ...
    public static void main(String[] args) {
        ...
        File newDir = new File("scenarios/cutoutWorldsSpeed/" + scenario_name);
        if (!newDir.exists()) {
            newDir.mkdirs();
        }
        ...
        cont_conf.setOutputDirectory("scenarios/cutoutWorldsSpeed/" + scenario_name + "/output");
        ...
        configWriter.write("scenarios/cutoutWorldsSpeed/" + scenario_name + "/config.xml");
        ...
        PopulationUtils.writePopulation(pop, "scenarios/cutoutWorldsSpeed/" + scenario_name + "/plans.xml");
        PopulationUtils.printPlansCount(pop);
        ...
        new NetworkWriter(network).write("scenarios/cutoutWorldsSpeed/" + scenario_name + "/network.xml");
