...
public class createScenarios_smallWorld {
    ...
    public static void main(String[] args) {
        ...
        File newDir = new File("scenarios/smallWorlds/" + scenario_name);
        if (!newDir.exists()) {
            newDir.mkdirs();
        }
        ...
        cont_conf.setOutputDirectory("scenarios/smallWorlds/" + scenario_name + "/output");
        ...
        configWriter.write("scenarios/smallWorlds/" + scenario_name + "/config.xml");

        System.out.println("2. READ IN JSON SCENARIO");
        JSONObject json_data = null;
        try {
            Object o = new JSONParser().parse(new FileReader("scenarios/smallWorlds/" + scenario_name + "/scenario.json"));
        ...
        networkwriter.write("scenarios/smallWorlds/" + scenario_name + "/network.xml");
        ...
        PopulationUtils.writePopulation(population, "scenarios/smallWorlds/" + scenario_name + "/plans.xml");
